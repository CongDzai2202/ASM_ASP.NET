...
namespace ShopOnline_ASM_NET104_CONGNCPH14366.Areas.Admin.Controllers
{
    ...
    public class AdminRolesController : Controller
    {
        ...
        public AdminRolesController(ShopOnlineContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("RoleId,RoleName,Descriptions")] Role role)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RoleId,RoleName,Descriptions")] Role role)
        {
            if (id != role.RoleId)
            {
                return NotFound();
