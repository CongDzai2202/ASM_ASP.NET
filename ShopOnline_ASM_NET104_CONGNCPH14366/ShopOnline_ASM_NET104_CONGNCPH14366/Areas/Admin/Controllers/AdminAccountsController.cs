...
namespace ShopOnline_ASM_NET104_CONGNCPH14366.Areas.Admin.Controllers
{
    ...
    public class AdminAccountsController : Controller
    {
        ...
        public AdminAccountsController(ShopOnlineContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("AccountId,Phone,Email,Pass,Salt,Active,FullName,RoleId")] Account account)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AccountId,Phone,Email,Pass,Salt,Active,FullName,RoleId")] Account account)
        {
