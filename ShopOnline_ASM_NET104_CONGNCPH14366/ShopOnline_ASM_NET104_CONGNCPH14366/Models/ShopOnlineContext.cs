...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=JWTMM5OHEEIIJGK\\SQLEXPRESS;Database=ShopOnline;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Account>(entity =>
            {
                ...
                entity.HasOne(d => d.Role)
                    ...
                    .HasConstraintName("FK__Accounts__RoleID__25869641");
            });

            modelBuilder.Entity<Category>(entity =>
            {
                entity.HasKey(e => e.CatId)
                    .HasName("PK__Categori__6A1C8ADA84C26C53");
            ...
            modelBuilder.Entity<Customer>(entity =>
            {
                ...
                entity.Property(e => e.Addresss).HasMaxLength(250);
                ...
                entity.HasOne(d => d.Location)
                    ...
                    .HasConstraintName("FK__Customers__Locat__2B3F6F97");
            });
            ...
            modelBuilder.Entity<Order>(entity =>
            {
                ...
                entity.HasOne(d => d.TransactStatus)
                    ...
                    .HasConstraintName("FK__Orders__Transact__403A8C7D");
            });
            ...
            modelBuilder.Entity<Product>(entity =>
            {
                ...
                entity.HasOne(d => d.Cat)
                    ...
                    .HasConstraintName("FK__Products__CatID__45F365D3");
            });
